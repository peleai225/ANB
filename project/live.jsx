...
function Router({ route, heroVariant = 'B' }) {
  ...
  switch (route) {
    ...
    case '/partenaire/dossier/nouveau':  return <PageViewport bg="var(--ink-50)"><PartnerNewDossier /></PageViewport>;
    case '/partenaire/clients':          return <PageViewport bg="var(--ink-50)"><PartnerClients /></PageViewport>;
    case '/partenaire/clients/detail':   return <PageViewport bg="var(--ink-50)"><PartnerClientDetail /></PageViewport>;
    ...
    case '/partenaire/aide':             return <PageViewport bg="var(--ink-50)"><PartnerParametres /></PageViewport>;
    case '/partenaire/services/comptabilite':   return <PageViewport bg="var(--ink-50)"><PartnerComptabilite /></PageViewport>;
    case '/partenaire/services/juridique':      return <PageViewport bg="var(--ink-50)"><PartnerJuridique /></PageViewport>;
    case '/partenaire/services/financement':    return <PageViewport bg="var(--ink-50)"><PartnerFinancement /></PageViewport>;
    case '/partenaire/services/representation': return <PageViewport bg="var(--ink-50)"><PartnerRepresentation /></PageViewport>;
    case '/partenaire/services/formation':      return <PageViewport bg="var(--ink-50)"><PartnerFormation /></PageViewport>;
    case '/partenaire/services/agrements':      return <PageViewport bg="var(--ink-50)"><PartnerAgrements /></PageViewport>;
    case '/admin/services/comptabilite':        return <PageViewport bg="var(--ink-50)"><PartnerComptabilite /></PageViewport>;
    case '/admin/services/juridique':           return <PageViewport bg="var(--ink-50)"><PartnerJuridique /></PageViewport>;
    case '/admin/services/financement':         return <PageViewport bg="var(--ink-50)"><PartnerFinancement /></PageViewport>;
    case '/admin/services/formation':           return <PageViewport bg="var(--ink-50)"><PartnerFormation /></PageViewport>;
    case '/admin/logs':                         return <PageViewport bg="var(--ink-50)"><AdminConfig /></PageViewport>;
    ...
    case '/admin/partenaires/detail':    return <PageViewport bg="var(--ink-50)"><AdminPartnerDetail /></PageViewport>;
