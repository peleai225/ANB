...
const TopBar = ({ title, sub }) => {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 32px', borderBottom: '1px solid var(--ink-200)', background: 'white', position: 'relative' }}>
      <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <button onClick={() => setNotifOpen((o) => !o)} className="btn btn-sm btn-ghost" style={{ width: 36, padding: 0, position: 'relative' }}>
